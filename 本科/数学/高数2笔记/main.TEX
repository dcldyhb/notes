...
\[\int_{\wideparen{AB}} f(x,y)\,\mathrm{d}s=\oint_{\wideparen{BA}} f(x,y)\,\mathrm{d}s\]
...
\[\int_{\wideparen{AB}} \vec{F}(x,y) \cdot \mathrm{d}\vec{r} = -\oint_{\wideparen{BA}} \vec{F}(x,y) \cdot \mathrm{d}\vec{r}\]
