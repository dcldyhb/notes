...
对幂级数 $\displaystyle \sum_{n=1}^\infty a_nx^n$，若 $\displaystyle \lim_{n\to+\infty}\left\vert\frac{a_{n+1}}{a_n}\right\vert = \rho$，则收敛半径 $\displaystyle R=\begin{cases}&0,&&\text{当}\rho=+\infty\newline\frac\end{cases}$
