...
4. $\displaystyle \ln(1+x) = \sum_{n=1}^\infty \frac{(-1)^{n-1}x^n}{n} \quad (|x|<1)$
5. $\displaystyle (1+x)^\alpha = \sum_{n=0}^\infty \frac{\alpha(\alpha-1)\cdots(\alpha-n+1)}{n!}x^n \quad (|x|<1)$
6. $\displaystyle \frac{1}{1-x} = \sum_{n=0}^\infty x^n \quad (|x|<1)$
7. $\displaystyle \frac{1}{1+x} = \sum_{n=0}^\infty (-1)^nx^n \quad (|x|<1)$
8. $\displaystyle \arctan{x} = \sum_{n=0}^\infty \frac{(-1)^n x^{2n+1}}{2n+1} \quad (|x|\leq 1)$
