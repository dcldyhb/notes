...
设正项级数 $\displaystyle \sum_{n=1}^\infty a_n$，$\displaystyle \sum_{n=1}^\infty b_n$ 满足 $a_n \leq b_n \quad (\forall n \in \mathbb{N}^+$ ，则 $\displaystyle \sum_{n=1}^\infty a_n$ 收敛 $\Rightarrow \displaystyle \sum_{n=1}^\infty b_n$ 收敛，$\displaystyle \sum_{n=1}^\infty b_n$ 发散 $\Rightarrow \displaystyle \sum_{n=1}^\infty a_n$ 发散
