...
$$
\mathbb{p} = m\mathbb{v} = \frac{m_0\mathbb{v}}{\sqrt{1-\frac{v^2}{c^2}}}  
$$

### 相对论中的力学基本方程

$$
\boldsymbol{p} = \frac{\mathrm{d}\mathbb{p}}{\mathrm{d}t} = \frac{\mathrm{d}}{\mathrm{d}t}\left(\frac{m_0\mathbb{v}}{\sqrt{1-\frac{v^2}{c^2}}}\right) = \frac{\mathrm{d}\mathbb{p}}{\mathrm{d}t} + \mathbb{p}\cdot\frac{\mathrm{d}}{\mathrm{d}t}\left(\frac{1}{\sqrt{1-\frac{v^2}{c^2}}}\right)
$$
