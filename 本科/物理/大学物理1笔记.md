...
若令 $\gamma = \frac{1}{\sqrt{1-\frac{u^2}{c^2}}}$，则有
...
设在 $S'$ 系中静止的物体的本征时间为 $\Delta t_0$，在 $S$ 系中测得的时间为 $\Delta t$，则有

$$
\Delat t = \gamma \Delta t_0
$$

#### 长度收缩

设在 $S'$ 系中静止的物体的本征长度为 $L_0$，在 $S$ 系中测得的长度为 $L$，则有
