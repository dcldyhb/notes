...
| 3   | 对称性             | 对称于实轴                                                                                                                                                                                                                                                       |
| 4   | 渐近线             | 相交于实轴上的同一点：<br><ul><li>坐标为： $\sigma_a = \frac{\sum_{i=1}^n p_i - \sum_{j=1}^m z_j}{n - m}$</li><li>倾角为： $\varphi = \frac{\pi \pm 2k\pi}{n - m}$</li></ul>                                                                                     |
...
| 8   | 虚轴交点           | <ol><li>满足特征方程 $1 + G(j\omega)H(j\omega) = 0$ 的 $\omega$ 值</li><li>由劳斯阵列求得（及 $K_1$ 响应的值）</li></ol>                                                                                                                                         |
